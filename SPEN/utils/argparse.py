...
def parse2config(config):
    ...
    # dataset
    parser.add_argument("--data", type=str, default="SPEEDConfig", help="Dataset", choices=["SPEEDData"])
    # exp_type
    ...
    parser.add_argument("--added_tokens_num", type=int, default=config.head_args["TokenHead"]["added_tokens_num"])
    # pos
    ...
    if config.neck in {"DensAttFPN", "TaileNeck"}:
    ...
    config.head_args["TokenHead"]["num_heads"] = args.num_heads
    config.head_args["TokenHead"]["num_layers"] = args.num_layers
    config.head_args["TokenHead"]["added_tokens_num"] = args.added_tokens_num
